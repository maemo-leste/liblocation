...
static int on_signal(int unused, DBusMessage *msg, gpointer obj) {
    ...
    if (!dbus_message_get_args(msg, &error,
        ...
        fprintf(stderr, "name: %s, time: %lf, longitude: %lf, lattitude: %lf\n", name, time, longitude, lattitude);
    }
...
int main() {
    ...
    // signal time=1604331638.623891 sender=:1.401 -> destination=(null destination) serial=6 path=/org/gpsd; interface=org.gpsd; member=fix
